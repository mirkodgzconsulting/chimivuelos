...
export default function MoneyTransfersPage() {
    ...
    const handleEdit = (transfer: MoneyTransfer) => {
        ...
        setFormData({
            ...
            client_email: transfer.profiles?.email || "",
            client_phone: transfer.profiles?.phone || "",
                                ...
                                <div className="space-y-2 relative">
                                    ...
                                    <div className="relative">
                                        <Input 
                                            ...
                                            onClick={() => !selectedTransferId && setIsClientDropdownOpen(true)}
                                            autoComplete="off"
                                            disabled={!!selectedTransferId} // Lock if editing
                                            className={`${selectedTransferId ? "bg-slate-100 text-slate-500 cursor-not-allowed" : ""} bg-white pr-8`}
                                        />
